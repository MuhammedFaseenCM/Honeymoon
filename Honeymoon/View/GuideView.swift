        ...
        ScrollView(.vertical, showsIndicators: false){
            VStack (alignment: .center, spacing: 20){
                ...
                VStack(alignment: .leading, spacing: 25) {
                    ...
                    GuideComponent(title: "Book", subtitle: "Tap the button", description: "Our selection of honeymon resorts is perfect setting for you to embark your new life together.", icon: "checkmark.square")
                }
                Spacer(minLength: 10)
                Button(action: {
